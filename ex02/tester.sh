...
# Tests
test_case "-1 5 2 13" "Error 2"
test_case "3 2 1 \"\"" "Error 2"
test_case "3 2 1 \"  \"" "Error 2"
test_case "3 2 1 \"\t\"" "Error 2"
test_case "3 2 1 \"\n\"" "Error 2"
test_case "2147483648" "Error 2"

random_input=$(shuf -i 1-100000 -n 3000 | tr "\n" " ")
test_case "1 ${random_input} -1" "Error 2"

random_input_with_spaces=" 1   7 4  2 9  5  8   3  6  "
test_case "${random_input_with_spaces}a" "Error 2"

random_input_with_tabs="1\t7\t4\t2\t9\t5\t8\t3\t6"
test_case "${random_input_with_tabs}\t-\t1" "Error 2"
